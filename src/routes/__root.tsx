...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NeoCast — Проверенный маркетплейс" },
      { name: "description", content: "NeoCast — проверенный маркетплейс с мгновенной доставкой и безопасными расчётами." },
      { property: "og:title", content: "NeoCast" },
      { property: "og:description", content: "NeoCast — проверенный маркетплейс с мгновенной доставкой и безопасными расчётами." },
