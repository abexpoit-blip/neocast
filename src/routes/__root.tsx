...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zoru Shop — Проверенный маркетплейс" },
      { name: "description", content: "Zoru Shop — проверенный маркетплейс с мгновенной доставкой и безопасными расчётами." },
      { property: "og:title", content: "Zoru Shop" },
      { property: "og:description", content: "Zoru Shop — проверенный маркетплейс с мгновенной доставкой и безопасными расчётами." },
