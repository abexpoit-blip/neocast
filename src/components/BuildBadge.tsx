...
export const BuildBadge = ({
  ...
  return (
    <div
      className={`${cls} pointer-events-none select-none rounded-full border border-border/40 bg-background/75 px-2.5 py-1 font-mono text-[10px] tracking-[0.18em] text-muted-foreground/80 backdrop-blur`}
